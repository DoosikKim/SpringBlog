...
<body>
    ...
    <header class="intro-header" style="background-image: url('http://cfile22.uf.tistory.com/image/266D1B3B5687D9050E1EE2')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1>${post.subject}</h1>
                        <h2 class="subheading">부 제목</h2>
                        <span class="meta">Posted by <a href="#">dskim98</a> on ${post.regDate}</span>
                    </div>
                </div>
            </div>
        </div>
